...
public record DriveFeedforwards(
    ...
    /**
     * Collection of different feedforward values for each drive module. If using swerve, these
     * values will all be in FL, FR, BL, BR order. If using a differential drive, these will be in
     * L, R order.
     *
     ...
     *     magnitude of these vectors will typically be greater than the linear force feedforwards
    ...
    public DriveFeedforwards interpolate(DriveFeedforwards endValue, double t) {
        return new DriveFeedforwards(
                ...
                interpolateArray(
                        robotRelativeForcesXNewtons, endValue.robotRelativeForcesXNewtons, t),
                interpolateArray(
                        robotRelativeForcesYNewtons, endValue.robotRelativeForcesYNewtons, t));
    }

    /**
     * Reverse the feedforwards for driving backwards. This should only be used for differential
     * drive robots.
     *
    ...
    /**
     * Flip the feedforwards for the other side of the field. Only does anything if mirrored
     * symmetry is used
     *
    ...
    public Force[] robotRelativeForcesX() {
        return Arrays.stream(robotRelativeForcesXNewtons)
                .mapToObj(Newtons::of)
                .toArray(Force[]::new);
    }
    ...
    public Force[] robotRelativeForcesY() {
        return Arrays.stream(robotRelativeForcesYNewtons)
                .mapToObj(Newtons::of)
                .toArray(Force[]::new);
    }
