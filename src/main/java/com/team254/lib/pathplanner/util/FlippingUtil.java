...
public class FlippingUtil {
    ...
    public enum FieldSymmetry {
        /**
         * Field is rotationally symmetric. i.e. the red alliance side is the blue alliance side
    ...
    /**
     * Flip field relative chassis speeds for the other side of the field, maintaining a blue
     * alliance origin
     *
