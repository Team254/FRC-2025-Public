package com.team254.lib.pathplanner.util.swerve;
    ...
    public SwerveSetpoint generateSetpoint(
        ...
        if (all_modules_should_flip
            ...
            return generateSetpoint(
                    prevSetpoint, new ChassisSpeeds(), constraints, dt, inputVoltage);
        }
        ...
        if (constraints != null) {
            ...
            if (linearAccel > constraints.maxAccelerationMPSSq()) {
                chassisAccelVec =
                        chassisAccelVec.times(constraints.maxAccelerationMPSSq() / linearAccel);
            }
            chassisAngularAccel =
                    MathUtil.clamp(
                            chassisAngularAccel,
